...
package com.zafar.ludogame2022;
...
public class MainActivity extends CordovaActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //====================================
        String[] publisherIds = {"ca-app-pub-4884978624677986"};
                    ...
                    case UNKNOWN:
                        ...
                        if(ConsentInformation.getInstance(MainActivity.this).isRequestLocationInEeaOrUnknown()){
                            ...
                            try {
                                ...
                                //============================================================
                                privacyUrl = new URL("https://onlineshoppingdealofficial.blogspot.com/p/ludo-game-2022-app.html");
